...
[AI Engine Pipeline](docs/AI-ENGINE-PIPELINE.md) |
...
- [Problem Statement](docs/PROBLEM_STATEMENT.md) — Challenge context and goals
- [Solution](docs/SOLUTION.md) — Full submission notes and architecture
- [AI Engine Pipeline](docs/AI-ENGINE-PIPELINE.md) — AI diagnosis and recovery pipeline details
- [Benchmark](docs/BENCHMARK.md) — Benchmark methodology and held-out dataset
- [Memory](docs/MEMORY.md) — Project memory and progress notes
- [Backend Endpoints](backend/ENDPOINTS.md) — Backend API documentation
- [Frontend Routes](frontend/ROUTES.md) — Frontend route notes
